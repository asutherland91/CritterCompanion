describe("Details User Flows", () => {
  context("when the API call is successful", () => {
    ...
    it("displays critter details when fetched successfully", () => {
      ...
      cy.get(".detail-image").should("have.attr", "src", "https://acnhapi.com/v1/images/bugs/1");
      ...
      cy.get(".month").should("contain.text", "Months found: September, October, November, December, January, February, March, April, May, June!");
      cy.get(".time").should("contain.text", "Time found: 4am - 7pm");
      cy.get(".catch-phrase").should("contain.text", "I caught a common butterfly! They often flutter by!");
    });
